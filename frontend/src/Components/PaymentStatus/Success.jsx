...
const Success = () => {
    return (
        <div class="flex items-center justify-center min-h-screen bg-gradient-to-r from-indigo-50 to-blue-50 light:from-gray-900 dark:to-gray-800">
            <div class="w-full max-w-2xl p-4 bg-white shadow-2xl dark:bg-gray-900 sm:p-10 sm:rounded-3xl">
                <div class="text-center">
                    ...
                    <p class="mt-4 text-sm text-gray-700 dark:text-gray-400">
                        ...
                        <Link to={'#'} class="font-medium text-indigo-600 dark:text-indigo-400 underline">
                            admin@eliteai.tools
                        </Link>
                    </p>
                </div>
